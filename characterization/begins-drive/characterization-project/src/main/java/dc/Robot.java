...
public class Robot extends TimedRobot {
  ...
  static private double WHEEL_DIAMETER = 4.633;
  ...
  public void robotInit() {
    ...
    WPI_VictorSPX leftSlave0 = new WPI_VictorSPX(14);
    leftSlave0.setInverted(true);
    leftSlave0.follow(leftMaster);
    leftSlave0.setNeutralMode(NeutralMode.Brake);
    WPI_VictorSPX leftSlave1 = new WPI_VictorSPX(13);
    ...
    WPI_VictorSPX rightSlave1 = new WPI_VictorSPX(1);
