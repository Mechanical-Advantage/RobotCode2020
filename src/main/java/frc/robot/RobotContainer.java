...
public class RobotContainer {
  ...
  private int backupDistanceFromWall = 12; // inches
  ...
  private void configureInputs() {
    ...
    driverOI.getBackupFromWallButton()
        .whenActive(new DriveDistanceOnHeading(driveSubsystem, ahrs, backupDistanceFromWall));
