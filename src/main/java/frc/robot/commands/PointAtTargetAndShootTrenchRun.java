...
public class PointAtTargetAndShootTrenchRun extends ParallelDeadlineGroup {
    ...
    private static final RectangularRegionConstraint trenchVelocityConstraint = new RectangularRegionConstraint(
            ...
            GeomUtil.inchesToMeters(trenchVelocityConstraintTopRight),
            new MaxVelocityConstraint(Units.inchesToMeters(80)));
    ...
    public PointAtTargetAndShootTrenchRun(DriveTrainBase driveTrain, RobotOdometry odometry,
        ...
        super(new ParallelCommandGroup(new PointAtTarget(driveTrain, limelight, ahrs),
                new WaitCommand(1).andThen(new WaitCommand(6).withInterrupt(() -> flywheel.atSetpoint()))).andThen(
                        ...
                        new NewRunMotionProfile(driveTrain, odometry, 0, List.of(trenchEnd, secondShotPosition), 0,
                                true, false),
