  ...
  public RunAutoNavBounce(RobotOdometry odometry, DriveTrainBase driveTrain, Intake intake) {
    ...
    mp2 = new NewRunMotionProfile(driveTrain, odometry, 0,
        List.of(new Pose2d(78, 145, Rotation2d.fromDegrees(100)),
            new CirclePath(new Translation2d(150, 57), 25, Rotation2d.fromDegrees(-180), new Rotation2d(), false)),
        velocityOverride, true, false, new ArrayList<>(), velocityOverride, accelerationOverride,
        centripetalAccelerationOverride, false);
    mp3 = new NewRunMotionProfile(driveTrain, odometry, velocityOverride,
        List.of(new Pose2d(175, 49, Rotation2d.fromDegrees(-90)), new Pose2d(208, 148, Rotation2d.fromDegrees(-90))), 0,
        true, false, new ArrayList<>(), velocityOverride, accelerationOverride, centripetalAccelerationOverride, false);
    mp4 = new NewRunMotionProfile(driveTrain, odometry, 0,
        List.of(new Pose2d(180, 120, Rotation2d.fromDegrees(-90)), new Pose2d(195, 60, Rotation2d.fromDegrees(-90)),
            new Pose2d(225, 50, new Rotation2d()), new Pose2d(270, 100, Rotation2d.fromDegrees(90))),
    ...
    mp5 = new NewRunMotionProfile(driveTrain, odometry, velocityOverride,
        List.of(new Pose2d(279, 52, Rotation2d.fromDegrees(90)), new Pose2d(275, 145, Rotation2d.fromDegrees(105))), 0,
        false, false, new ArrayList<>(), velocityOverride, accelerationOverride, centripetalAccelerationOverride,
        false);
    mp6 = new NewRunMotionProfile(driveTrain, odometry, 0,
        List.of(new Pose2d(275, 145, Rotation2d.fromDegrees(105)), new Pose2d(315, 105, Rotation2d.fromDegrees(150))),
    ...
    if (odometry != null && driveTrain != null && intake != null) {
      addCommands(new SequentialCommandGroup(
          ...
          new InstantCommand(() -> odometry.setPosition(new Translation2d(190, 120))), mp4,
          new InstantCommand(() -> odometry.setPosition(new Translation2d(279, 52))), mp5, mp6,
  ...
  public static void main(String[] args) {
    ...
    NewRunMotionProfile.runVisualizer(
        List.of(cmd.mp1.visualizerGetTrajectory(), cmd.mp2.visualizerGetTrajectory(), cmd.mp3.visualizerGetTrajectory(),
            cmd.mp4.visualizerGetTrajectory(), cmd.mp5.visualizerGetTrajectory(), cmd.mp6.visualizerGetTrajectory()),
